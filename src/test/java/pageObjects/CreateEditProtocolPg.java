...
public class CreateEditProtocolPg {
    ...
    @FindBy(xpath = "//div[@class='selected-exercises']/div/span[@class='reorder']")
    WebElement reOrderExc;
    ...
    @FindBy(xpath = "//div[@class='plan-table']/div[2]/div[1]/div[3]/div[1]/div[2]/div")
    ...
    @FindBy(xpath = "//i[@analytics-event='Reorder Assessments']")
    WebElement reOrderAss;
    ...
    WebElement updateProtBtn;
    
    @FindBy(xpath = "//*[@id='plan-builder']/div[4]/div/div[2]/div[2]/button")
    WebElement saveAsProtBtn;
    
    @FindBy(xpath = "//*[@id='plan-builder']/div[4]/div/div[3]")
    WebElement cancelProtBtn;
    ...
    public CreateEditProtocolPg(WebDriver driver) {
        ...
        this.createEdProtElements = new ArrayList<>(Arrays.asList(searchExcTxtBox, 
        exercisesTab, assessmentsTab, e01Bal3WayStarGrid, saveAsProtBtn));
        this.savingProtElements = new ArrayList<>(Arrays.asList(protNameSaveTxtBox,
        protDescSaveTxtBox, cancelProtSaveBtn, saveProtSaveBtn));
    }
    
    public void waitForPgLoad() {
        waitForVisibilityList(createEdProtElements, 7, driver);
    }
    
    public void searchExcAssess(String exercise) {
        searchExcTxtBox.sendKeys(exercise);
    }
    
    public WebElement getSearchTxt() {
        return searchExcTxtBox;
    }
    
    public void clickExcercisesTab() {
        exercisesTab.click();
        log.info("Clicked Exercises Tab");
        waitForVisibility(e01Bal3WayStarGrid, 2, driver);
    }
    
    public void clickAssessmentsTab() {
        assessmentsTab.click();
        log.info("Clicked Assessments Tab");
        waitForVisibility(a03KneeExtTest, 2, driver);
        log.info("Assessment List Displayed");
    }
    
    public void selectExcercises() {
        e39SeatKneeFlexStrch.click();
        log.info("Clicked e39SeatKneeFlexStrch");
        e01Bal3WayStarGrid.click();
        log.info("Clicked e01Bal3WayStarGrid");
        e84VMOKicks.click();
        log.info("Clicked e84VMOKicks");
    }
    
    public void selectAssessments() {
        a02FeetTgthrBalTest.click();
        log.info("Clicked a01KneeExtTest");
        a04KneeFlexSitTest.click();
        log.info("Clicked a08KneeFlexSitTest");
        waitForVisibility(freqClickDrpRowA, 2, driver);
    }
    
    public void viewExcerciseDesc() {
    ...
    public void clickOKBtn() {
        try {
            ...
            waitForVisibility(okBtn, 1, driver);
            org.testng.Assert.fail("Test FAILED");
        } catch (Exception e) {
            log.info("Description window closed");
        }
    }
    
    public void clickCancelProtBtn() {
        cancelProtBtn.click();
    ...
    public void checkSR() {
        try {
            waitForClick(srChkBoxRowE, 2, driver);
            log.info("SR checkbox is clickable");
        } catch (Exception e) {
            org.testng.Assert.fail("Test FAILED");
        }
    }
    
    public void clickBiasDrp() {
        biasClickDrpRowE.click();
        log.info("Clicked Bias Dropdown List");
    }
    
    public void clickSetsDrp() {
        setsClickDrpRowE.click();
        log.info("Clicked Sets Dropdown List");
    }
    
    public void clickRepsDrp() {
        repsClickDrpRowE.click();
        log.info("Clicked Reps Dropdown List");
    }
    
    public void clickXDaysDrp() {
        xDayClickDrpRowE.click();
        log.info("Clicked X/Day Dropdown List");
    }
    
    public void clickFreqDrp() {
        freqClickDrpRowE.click();
        log.info("Clicked Frequency Dropdown List");
    }
    
    public void clickEditOptEx() {
        editOptLinkRowE.click();
        log.info("Clicked Edit Options");
    }
    
    public void clickEquipDrp() {
        equipClickDrpRowE.click();
        log.info("Clicked Equipment Dropdown List");
    }
    
    public void clickRestSetDrp() {
        restSetClickDrpRowE.click();
        log.info("Clicked Rest between Sets Dropdown List");
    }
    
    public void clickExpCollExc() {
        expColExcercises.click();
        log.info("Clicked Expand/Collapse Excercises");
    }
    
    public void clickExpCollAssess() {
        expColAssessmnt.click();
        log.info("Clicked Expand/Collapse Assessments");
    }
    public void clickReorderExc() {
        reOrderExc.click();
        log.info("Clicked Reorder Exercises Button");
    }
    
    public void clickReorderAss() {
        reOrderAss.click();
        log.info("Clicked Reorder Assessments Button");
    }
    
    public void clickExtraOptnRowE() {
        extraOptRowE.click();
        log.info("Clicked Extra Options in Excercises Row");
    }
    
    public void deleteExc() {
        clickExtraOptnRowE();
        delExtraOptnRowE.click();
        log.info("Clicked Delete Extra Option");
        log.info("Deleted Excercise");
    }
    
    public void copyExc() {
        clickExtraOptnRowE();
        copyExtraOptnRowE.click();
        log.info("Clicked Copy Extra Option");
        log.info("Copied Excercise");
    }
    
    public void resetValExc() {
        clickExtraOptnRowE();
        resetExtraOptnRowE.click();
        log.info("Clicked Reset Default Values Option");
    }
    
    public void clickSaveAsProt() {
        saveAsProtBtn.click();
        log.info("Clicked Saved as New Protocol");
        waitForVisibilityList(savingProtElements, 2, driver);
        log.info("Elements for Saving Protocol Displayed");
    }
    
    public void checkClickSaveAsProt() {
        try {
            waitForClick(saveAsProtBtn, 2, driver);
            org.testng.Assert.fail("Test FAILED, Button is Clickable");
        } catch (Exception e) {
            log.info("PASS, Button is not Clickable");
        }
    }
    
    public void checkDisableProtSaveBtn() {
        try {
            waitForClick(saveProtSaveBtn, 2, driver);
            org.testng.Assert.fail("Test FAILED");
        } catch (Exception e) {
            log.info("Save as Button Disabled");
            log.info("PASS");
        }       
    }
    ...
    public void clickClearSearch() {
        ...
        log.info("Clicked Clear Seach Button");
    }
           
    public void changeFreqA(String input) {
        freqClickDrpRowA.click();
        log.info("Clicked Frequency Dropdown Menu");
        freqTxtBoxRowA.sendKeys(input, Keys.ENTER);
        log.info("Changed Frequency to: " + input);
    }
    
    public void changeBiasA(String input) {
        biasClickDrpRowA.click();
        log.info("Clicked Bias Dropdown Menu");
        biasTxtBoxRowA.sendKeys(input, Keys.ENTER);
        log.info("Changed Bias to: " + input);
    }
    
    public void clickExtraOptnRowA() {
        extraOptRowA.click();
        log.info("Clicked Extra Options in Assessments Row");
    }
    
    public void deleteAss() {
        clickExtraOptnRowA();
        delExtraOptnRowA.click();
        log.info("Clicked Delete Extra Options");
        log.info("Assessment Deleted");
    }
    
    public void copyAss() {
        clickExtraOptnRowA();
        copyExtraOptnRowA.click();
        log.info("Clicked Copy Extra Options");
        log.info("Assessment Copied");
    }
    
    public void resDefaultAss() {
        clickExtraOptnRowA();
        resetExtraOptnRowA.click();
        log.info("Clicked Reset Default Values Extra Options");
        log.info("Values Reset to Default");
    }
    
    public void clickClearAllExAs() {
        clearAllBtn.click();
        log.info("Clicked Clear All Button");
        log.info("Excercises and Assessments Cleared");
    }
    
    public void addSameAssessment() {
        a02FeetTgthrBalTest.click();
        log.info("Clicked a01KneeExtTest");
        a02FeetTgthrBalTest.click();
        log.info("Clicked a01KneeExtTest");
